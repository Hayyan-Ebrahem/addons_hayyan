...
class IncomeStatement(models.AbstractModel):
    _name = 'report.account.report_incomestatement'
    ...
    def _compute_account_balance(self, accounts):
        ...
        if accounts:
            ...
            for row in self.env.cr.dictfetchall():
                res[row['id']] = row
        print ('22222222 report.account.report_financial res:',res)
        return res
    ...
    def get_account_lines(self, data):
        ...
        print('****************** data[account_report_id] ', data['account_report_id'])
        ...
        # print('financial report (BalanceSheet lines:)\n')
        # for record in lines:
        #     print(record['name'],' ',record['balance'])
        return lines
